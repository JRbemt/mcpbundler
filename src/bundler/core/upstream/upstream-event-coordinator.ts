...
export class UpstreamEventCoordinator extends EventEmitter {
    ...
    private upstreamListeners: Map<IUpstreamConnector, {
        toolsChanged: () => void;
     ...
     */
    public attachUpstream(upstream: IUpstreamConnector): void {
     ...
     */
    private handleUpstreamToolsChanged(upstream: IUpstreamConnector): void {
        logger.info({
     ...
     */
    private handleUpstreamResourcesChanged(upstream: IUpstreamConnector): void {
        logger.info({
            sessionId: this.sessionId,
            namespace: upstream.getNamespace()
     ...
     */
    private handleUpstreamPromptsChanged(upstream: IUpstreamConnector): void {
        logger.info({
            sessionId: this.sessionId,
            namespace: upstream.getNamespace()
