...
import { BearerTokenAuthProvider } from "../../client/bearer-auth.js";
...
export class StdioToSseBridge {
  ...
  constructor(config: BridgeConfig) {
    ...
    this.sseTransport = new SSEClientTransport(sseUrl, {
      authProvider: new BearerTokenAuthProvider(this.config.token),
    });
